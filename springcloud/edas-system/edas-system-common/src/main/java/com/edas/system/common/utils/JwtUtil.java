...
import com.edas.system.common.constants.CommonConstant;
import com.edas.system.common.constants.SecurityConstant;

import io.jsonwebtoken.Claims;
import io.jsonwebtoken.Jwts;

/**
 * @author hybin 用户相关工具类
 */
public class JwtUtil {
	...
	private static String buildToken(String token) {
		if (StringUtils.isBlank(token))
			return null;
		if (!token.contains(CommonConstant.TOKEN_SPLIT))
			return token;
