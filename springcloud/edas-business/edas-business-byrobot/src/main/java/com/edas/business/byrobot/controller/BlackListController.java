...
import com.edas.business.byrobot.service.BlackListService;
...
/**
 * <p>
 * File Name: BlackListController.java
 * </p>
 * <p>
...
public class BlackListController {
    ...
    public RetResult<Object> findByCompanyId(@RequestParam(value="companyId",required = true) int companyId) throws Exception { 
		BlackList blackList = new BlackList();
		blackList.setCompanyId(companyId);	
        return RetResponse.makeOKRsp(blackListService.select(blackList));
    }
    ...
    public RetResult<Object> list(@RequestParam(value="page",required = true) int page, 
		...
		List<BlackList> list = blackListService.selectAll();
    ...
    public RetResult<Object> save(@RequestBody @Valid BlackList blackList) throws Exception {  				
