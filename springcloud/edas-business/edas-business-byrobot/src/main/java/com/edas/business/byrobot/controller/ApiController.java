...
import com.edas.business.byrobot.service.CallResultService;
import com.edas.business.byrobot.service.CompanyService;
import com.edas.business.byrobot.service.PhoneTaskService;
import com.edas.business.byrobot.service.XyRecordService;
...
public class ApiController {
	...
	public RetResult<Object> getCompany() {			
	...
	public RetResult<Object> upload(HttpServletRequest request) throws Exception {
		if(ServletFileUpload.isMultipartContent(request)) {			
