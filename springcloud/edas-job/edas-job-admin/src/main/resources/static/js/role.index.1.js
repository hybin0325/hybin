$(function() {
	...
	// init date tables
	var roleListTable = $("#role_list").dataTable({
		"deferRender": true,
		"processing" : true, 
	    "serverSide": true,
		"ajax": {
	...
	$('#searchBtn').on('click', function(){
        roleListTable.fnDraw();
	});
	
	// job operate
	$("#role_list").on('click', '.delete',function() {
	...
	var addModalValidate = $("#addModal .form").validate({
        ...
        submitHandler : function(form) {
        	...
        	$.post(base_url + "/role/add", paramData, function(data, status) {
    			if (data.code == "200") {
					$('#addModal').modal('hide');
	...
	var updateModalValidate = $("#updateModal .form").validate({
        ...
        submitHandler : function(form) {
            ...
            $.post(base_url + "/role/update", paramData, function(data, status) {
                if (data.code == "200") {
