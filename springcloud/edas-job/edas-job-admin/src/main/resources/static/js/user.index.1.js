$(function() {
	...
	var addModalValidate = $("#addModal .form").validate({
        ...
        submitHandler : function(form) {
            ...
            var roleArr = [];
            $("#addModal .form input[name=roles]:checked").each(function(){
	...
	$("#user_list").on('click', '.update',function() {
		...
		var roleIdArr=row.setRole.map(function (item) {
   	　　　　	return item['id']; 
   	 	});
		$("#updateModal .form input[name='roles']").each(function () {
            if($.inArray($(this).val(), roleIdArr) > -1) {
	...
	var updateModalValidate = $("#updateModal .form").validate({
        ...
        submitHandler : function(form) {
            ...
            var roleArr = [];
            $("#updateModal .form input[name=roles]:checked").each(function(){
            	roleArr.push($(this).val());
            });
