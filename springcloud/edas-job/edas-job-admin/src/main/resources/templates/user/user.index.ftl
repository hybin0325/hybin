			              	...
			              	<table id="user_list" class="table table-bordered table-striped" width="100%" >
				                <thead>
					            	<tr>
                                        ...
                                        <th name="name" >${I18n.user_name}</th>
			...
			<div class="modal-header">
         	...
         	<div class="modal-body">
				<form class="form-horizontal form" role="form" >
                    ...
                    <div class="form-group">
                        <label for="lastname" class="col-sm-2 control-label">${I18n.user_name}<font color="red">*</font></label>
                        <div class="col-sm-8"><input type="text" class="form-control" name="name" placeholder="${I18n.system_please_input}${I18n.user_name}" maxlength="20" ></div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <#if roleList?exists && roleList?size gt 0>
								<#list roleList as item>
                                    <input type="checkbox" name="roles" value="${item.id}" />${item.name}(${item.code})<br>
								</#list>
							</#if>
                        </div>
                    </div>
