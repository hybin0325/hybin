		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<#if Request["XXL_JOB_LOGIN_IDENTITY"].role == 1>
                    ...
                    <li class="nav-click <#if pageName == "role">active</#if>" ><a href="${request.contextPath}/role"><i class="fa fa-circle-o text-purple"></i><span>${I18n.role_manage}</span></a></li>
                    <li class="nav-click <#if pageName == "resource">active</#if>" ><a href="${request.contextPath}/resource"><i class="fa fa-circle-o text-purple"></i><span>${I18n.resource_manage}</span></a></li>
