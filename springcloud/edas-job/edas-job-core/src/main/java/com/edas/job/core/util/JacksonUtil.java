package com.edas.job.core.util;
...
public class JacksonUtil {
	...
	/*
	 * public static <T> T readValueRefer(String jsonStr, Class<T> clazz) { try {
	 * return getInstance().readValue(jsonStr, new TypeReference<T>() { }); } catch
