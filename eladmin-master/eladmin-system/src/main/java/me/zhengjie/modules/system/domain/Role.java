...
public class Role implements Serializable {
    ...
    @ManyToMany
    @JoinTable(name = "roles_groups", joinColumns = {@JoinColumn(name = "role_id",referencedColumnName = "id")}, inverseJoinColumns = {@JoinColumn(name = "group_id",referencedColumnName = "id")})
    private Set<Dept> groups;
