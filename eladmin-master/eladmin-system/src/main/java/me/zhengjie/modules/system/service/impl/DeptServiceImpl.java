...
public class DeptServiceImpl implements DeptService {
    ...
    @Cacheable
    public List<DeptDto> queryTreeAll(DeptQueryCriteria criteria) {
    	DeptQueryCriteria criteria1=new DeptQueryCriteria();
    	criteria1.setLevel(1);
    	List<DeptDto> list1= queryAll(criteria1);
    	for (DeptDto deptDto : list1) {
    		DeptQueryCriteria criteria2=new DeptQueryCriteria();
        	criteria2.setLevel(2);
        	criteria2.setPid(deptDto.getId());
        	List<DeptDto> list2= queryAll(criteria2);
        	deptDto.setChildren(list2);
        	for (DeptDto deptDto2 : list2) {
        		DeptQueryCriteria criteria3=new DeptQueryCriteria();
            	criteria3.setLevel(3);
            	criteria3.setPid(deptDto.getId());
            	List<DeptDto> list3= queryAll(criteria3);
            	deptDto2.setChildren(list3);
			}
		}
    	return list1;
    }
