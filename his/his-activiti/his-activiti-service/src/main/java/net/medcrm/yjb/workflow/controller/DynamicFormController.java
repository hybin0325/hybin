...
public class DynamicFormController {
    ...
    public Object processDefinitionList(Model model, @RequestParam(value = "processType", required = false) String processType,
    ...
    public Object finished(Model model, @RequestParam(value = "processType", required = false) String processType,
        ...
        return new BaseResp<Page<HistoricProcessInstance>>(page);
    }
