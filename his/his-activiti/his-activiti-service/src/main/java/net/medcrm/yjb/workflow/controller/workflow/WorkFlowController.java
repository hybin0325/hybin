package net.medcrm.yjb.workflow.controller.workflow;
...
import net.medcrm.yjb.workflow.service.impl.WorkflowProcessDefinitionService;
...
//    Context.setProcessEngineConfiguration(defaultProcessEngine.getProcessEngineConfiguration());
    ...
    @RequestMapping(value = "jump/{id}", method = { RequestMethod.POST, RequestMethod.GET })
	@ResponseBody
	public String taskRollback(@PathVariable("id") String taskId) {
		try {
			// 根据要跳转的任务ID获取其任务
	...
	@RequestMapping(value = "task/jump", method = { RequestMethod.POST })
	@ResponseBody
	public String jumpTask(@RequestParam("taskId") String taskId, @RequestParam("activityId") String activityId) {
		try{
			// 根据要跳转的任务ID获取其任务
