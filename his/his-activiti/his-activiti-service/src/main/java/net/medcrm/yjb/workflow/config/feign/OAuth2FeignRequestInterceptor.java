...
public class OAuth2FeignRequestInterceptor implements RequestInterceptor {
    ...
    public void apply(RequestTemplate template) {
        /*LOGGER.debug("Constructing Header {} for Token {} , Token Values is {}", AUTHORIZATION_HEADER, BEARER_TOKEN_TYPE, oAuth2RestTemplate.getAccessToken().toString());
        ...
        System.out.println(AccessTokenLocal.getCurrentLocalToken());
        template.header(AUTHORIZATION_HEADER,
                AccessTokenLocal.getCurrentLocalToken());
