...
public class ProcessInstanceHighlightsResource {
	...
	@RequestMapping(value = "/process-instance/highlights", method = RequestMethod.GET, produces = "application/json")
	public ObjectNode getHighlighted2(String processInstanceId) {
