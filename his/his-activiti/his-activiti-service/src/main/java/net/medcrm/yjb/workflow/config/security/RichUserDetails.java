...
public class RichUserDetails implements UserDetails, CredentialsContainer {
    ...
    public RichUserDetails(String id, String phone, String loginNmae, String password,
                           Collection<? extends GrantedAuthority> authorities) {
        this(id, phone, loginNmae, password, true, true, true, true, authorities);
    }
    
    public RichUserDetails(String id, String phone, final String loginNmae, String password,
                           boolean enabled,
