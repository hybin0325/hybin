...
public class BaseResponse {
    ...
    public static BaseResponse buildResult(){
    ...
    public BaseResponse redirectUrl(String redirectUrl){
        setRedirectUrl(redirectUrl);
        return this;
    }

    public BaseResponse back(){
        setBack(true);
        return this;
    }
    ...
    public BaseResponse putExtra(String name, Object val){
        ((HashMap<String, Object>)data.get("extra")).put(name, val);
        return this;
    }
    public BaseResponse setObjData(Object obj){
        data.put("obj", obj);
        return this;
    }

    public BaseResponse rows(Rows rows){
        setRows(rows);
        return this;
    }
    ...
    public BaseResponse setRows(Rows rows) {
        data.put("rows", rows);
        return this;
    }
