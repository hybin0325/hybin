...
public class WebConfig  extends WebMvcConfigurerAdapter {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.his.oauth"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("访问控制权限模块API DOCUMENT")
                .description("医极棒管理系统")
                .termsOfServiceUrl("http://192.168.0.108:7777/his-authorization-oauth/swagger-ui.html")
                .contact("林盛")
                .version("1.0")
                .build();
    }
