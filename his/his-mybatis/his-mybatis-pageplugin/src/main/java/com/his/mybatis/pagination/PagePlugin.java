...
import com.his.mybatis.dialect.Dialect;
import com.his.mybatis.dialect.MysqlDialect;
import com.his.mybatis.utils.ReflectUtils;
...
public class PagePlugin implements Interceptor {
	...
	public String countSql(String sql) {
		return new StringBuffer("SELECT COUNT(1) AS ROW_COUNT FROM ( ").append(sql).append(" ) AS COUNT_QUERY")
				.toString();
	}
